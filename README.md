...
The VSC v2.8 Node/Go Result Comparison Draft is available in [`conformance/v2.8/`](conformance/v2.8/). It defines how verifier implementations should compare result classes across the v2.7 conformance fixtures. The v2.8.1 comparison runner is implemented: `node scripts/compareConformanceResults.js` or `npm run vsc -- compare:fixtures`.
